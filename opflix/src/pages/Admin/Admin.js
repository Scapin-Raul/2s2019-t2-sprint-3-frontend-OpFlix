...
class Admin extends Component {
    ...
    componentDidMount() {
        ...
        fetch('http://192.168.4.93:5000/api/Categorias/', {
            method: 'GET',
            headers: {
    ...
    editarTitulo = (e) => {
        ...
        const url = 'http://192.168.4.93:5000/api/Titulos/' + id;
        console.log(url);
    ...
    adicionarTitulo = () => {
        ...
        const url = 'http://192.168.4.93:5000/api/Titulos/';
    ...
    deletarTitulo = () => {
        ...
        const url = 'http://192.168.4.93:5000/api/Titulos/' + idTituloDeletar;
    ...
    cadastrarCategoria = (e) => {
        ...
        const url = "http://192.168.4.93:5000/api/Categorias/"
        axios.post(url, {
            nome: nomeCategoria
        },
            {
    ...
    deletarCategoria = (e) => {
        ...
        const url = 'http://192.168.4.93:5000/api/Categorias/' + idCategoriaDeletar;
    ...
    cadastrarPlataforma = (e) => {
        ...
        const url = "http://192.168.4.93:5000/api/Plataformas/"
        axios.post(url, {
            nome: nomePlataforma
        },
            {
    ...
    deletarPlataforma = (e) => {
        ...
        const url = 'http://192.168.4.93:5000/api/Plataformas/' + idPlataformaDeletar;
